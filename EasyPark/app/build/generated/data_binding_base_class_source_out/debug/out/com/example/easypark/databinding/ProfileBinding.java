...
public final class ProfileBinding implements ViewBinding {
  ...
  @NonNull
  public final Button viewpoints;

  private ProfileBinding(@NonNull ConstraintLayout rootView, @NonNull TextView Address,
      @NonNull TextView Email, @NonNull TextView Header, @NonNull TextView Points,
      @NonNull TextView Username, @NonNull BottomNavigationView bottomNavigation,
      ...
      @NonNull LinearLayout linearLayout2, @NonNull TextView phoneNumber,
      @NonNull ImageView profileImage, @NonNull Button viewpoints) {
  ...
  public static ProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.viewpoints;
      Button viewpoints = ViewBindings.findChildViewById(rootView, id);
      if (viewpoints == null) {
        break missingId;
      }

      return new ProfileBinding((ConstraintLayout) rootView, Address, Email, Header, Points,
          Username, bottomNavigation, imageView4, imageView5, imageView6, imageView7, linearLayout,
          linearLayout2, phoneNumber, profileImage, viewpoints);
    }
