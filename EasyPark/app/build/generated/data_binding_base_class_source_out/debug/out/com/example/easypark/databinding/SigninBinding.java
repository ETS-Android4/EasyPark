...
public final class SigninBinding implements ViewBinding {
  ...
  private SigninBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2,
      @NonNull SignInButton signInButton, @NonNull TextView textView, @NonNull TextView textView7) {
  ...
  public static SigninBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SigninBinding((ConstraintLayout) rootView, imageView2, signInButton, textView,
          textView7);
    }
